  ...
  return (
    <>
      ...
      <main className="pt-28 relative pb-20 text-center">
        <motion.h2 initial={{ opacity: 0, translateY: '30px' }} whileInView={{ opacity: 1, translateY: 0, transitionDuration: 0.5 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="font-extrabold text-6xl py-5 xl:mx-40 2xl:mx-80 lg:text-8xl text-black dark:text-white md:text-6xl heading foldIndexTitle">
          Hi! I&apos;m Anyelo Petit
        </motion.h2>
